	...
	<div class="main__wrapper">
		<div class="nav">
			<ul>
				...
				<li class="item active"><a href="/AssignmentJava5/admin/list"> <i
						class="fa-solid fa-tag"></i>
				</a></li>
				<li class="item "><a href="/AssignmentJava5/admin/cart">
				...
				<div class="banner"
					...
					<div class="banner__content">
						...
						<div class="btn-action">
							...
							<a href="/Assignment/admin/delete?id=${product.id}"> Sửa </a>
							</button> --%>
							
							<button class="btn btn-edit"
								onclick="window.location.href='/AssignmentJava5/admin/update/${product.id}'">
								<i class="fa-solid fa-pen-to-square"></i> Sửa
							</button>
							<button class="btn btn-delete"
								onclick="window.location.href='/AssignmentJava5/admin/delete/${product.id}'">

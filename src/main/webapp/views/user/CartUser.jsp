	...
	<div class="main__wrapper">
		...
		<div class="sidebar">
			...
			<div class="sidebar__fillter-wrapper">
				<form action="/AssignmentJava5/user/find" method="POST">
										...
										<div class="card-body">
											...
											<div class="row">
												...
												<div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
													...
													<p>Size: M</p>
													<button type="button"
														onclick="window.location.href='/AssignmentJava5/user/cart/delete/${x.id}'"
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								...
								<button type="button" class="btn btn-primary btn-lg btn-block"
									onclick="window.location.href='/AssignmentJava5/user/checkout'">

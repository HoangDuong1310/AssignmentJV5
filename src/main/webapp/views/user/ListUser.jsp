...
<body>
	<div class="main__wrapper">
		<div class="nav">
			<ul>
				...
				<li class="item active"><a href="/AssignmentJava5/user/list">
						<i class="fa-solid fa-tag"></i>
				</a></li>
				<li class="item "><a href="/AssignmentJava5/user/cart"> <i
		...
		<div class="sidebar">
			...
			<div class="sidebar__fillter-wrapper">
				<form action="/Assignment/user/find" method="POST">
			...
			<div class="content">
				<div class="list__card">
					<c:forEach items="${list.content}" var="x">
						<div class="card">
							<a href="/AssignmentJava5/user/card-detail/${x.id}">
								<div class="card__top">
								...
								<div class="card__main">
									...
									<div class="card__main-like">
										...
										<a class="btn__add-cart"
											href='/AssignmentJava5/user/cart/add/${x.id}'>add to
											cart</a>
									</div>
								</div>
							</a>
  ...
  <a href="/AssignmentJava5/user/list?p=0">&laquo;</a>
  <a href="/AssignmentJava5/user/list?p=${list.number - 1}">❮</a>
  <a href="/AssignmentJava5/user/list?p=${list.number + 1}">❯</a>
  <a href="/AssignmentJava5/user/list?p=${list.totalPages - 1}">&raquo;</a>
</div>
		</div>
	</div>
	</div>

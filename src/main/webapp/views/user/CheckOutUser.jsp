	...
	<div class="main__wrapper">
		<div class="nav">
			<ul>
				...
				<li class="item "><a href="/AssignmentJava5/user/list"> <i
						class="fa-solid fa-tag"></i>
				</a></li>
				<li class="item active"><a href="/AssignmentJava5/user/cart">
						<i class="fa-solid fa-cart-shopping"></i>
				</a></li>
				<li class="item "><a href="/AssignmentJava5/user/accountlist">
		...
		<div class="sidebar">
			...
			<div class="sidebar__fillter-wrapper">
				<div class="btn__add">
					<button
						onclick="window.location.href='/AssignmentJava5Java5/user/insert'">Thêm</button>
				</div>
		...
		<div class="content__wrap">
			<div class="content">
				<div class="container my-5 py-5">
					<form action="/AssignmentJava5/user/pay" method="post">
										...
										<div class="card-header py-3">
											<h5 class="mb-0 text-font">
												item <span class="float-end mt-1" style="font-size: 13px;"><a
													href="http://localhost:8080/AssignmentJava5/user/cart">Edit</a></span>
											</h5>
										</div>
										<div class="card-body">

	...
	<div class="main__wrapper">
		<div class="nav">
			<ul>
				...
				<li class="item active"><a href="/AssignmentJava5/admin/list">
		...
		<div class="sidebar">
			...
			<div class="sidebar__fillter-wrapper">
				...
				<div class="btn__add">
					<button
						onclick="window.location.href='/AssignmentJava5/admin/insertCate'">Thêm
						danh mục</button>
				</div>
			</div>
		...
		<div class="content__wrap">
			<div class="content">
				<div class="list__card">
					<c:forEach items="${list.content}" var="x">
						<c:if test="${x.available == false}">
							<div class="card">
								<a href="/AssignmentJava5/admin/card-detail/${x.id}">
									<div class="card__top">
									...
									<div class="card__main">
										...
										<div class="card__main-like">
											...
											<a class="btn__add-cart"
												href='/AssignmentJava5/admin/cart/add/${x.id}'>add to
												cart</a>
										</div>
									</div>
								</a>
						...
						<c:if test="${x.available == true}">
							<div class="card card__delete">
								<div class="text__delete">Hết Hàng</div>
			...
			<div class="pagination">
				<a href="/AssignmentJava5/admin/list?p=0">&laquo;</a> <a
					href="/AssignmentJava5/admin/list?p=${list.number - 1}">❮</a> <a
					href="/AssignmentJava5/admin/list?p=${list.number + 1}">❯</a> <a
					href="/AssignmentJava5/admin/list?p=${list.totalPages - 1}">&raquo;</a>
			</div>
		</div>
	</div>
	<script>

...
<body>
	<section class="get-in-touch">
		...
		<f:errors class="title error" path="name"> </f:errors>
		<f:form class="contact-form row" action="/AssignmentJava5/admin/insert" modelAttribute="insert"
			method="POST" >
			...
			<div class="form-field col-lg-6 ">
			<f:errors path="*"></f:errors>
				<f:input id="company" path="description" class="input-text js-input"
					type="text"/> <label class="label">description</label>
			</div>
			<div class="form-field col-lg-6 ">
				<f:input id="" path="price" class="input-text js-input"
			...
			<div class="form-field col-lg-6 d-flex align-items-center">
				...
				<f:input id="phone" path="image" class="input-text js-input" type="file"/>
			</div>
			<div class="form-field col-lg-6 d-flex align-items-center">
			...
			<div class="form-field col-lg-6 d-flex align-items-center">
				<f:select path="category"  class="form-control">
						<c:forEach var="x" items="${listCategory}">
							<f:option value="${x.id}">${x.name}</f:option>
						</c:forEach>	
						</f:select>
			</div>

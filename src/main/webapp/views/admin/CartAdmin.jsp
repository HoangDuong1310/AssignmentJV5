										...
										<div class="card-body">
											...
											<div class="row">
												...
												<div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
													...
													<p>Size: M</p>
													<button type="button"
														onclick="window.location.href='/AssignmentJava5/admin/cart/delete/${x.id}'"
												...
												<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
													...
													<div class="d-flex mb-4" style="max-width: 300px">
														<button class="btn btn-primary px-3 me-2"
															onclick="window.location.href='/AssignmentJava5/admin/cart/update">
														...
														<button class="btn btn-primary px-3 ms-2"
															onclick="window.location.href='/AssignmentJava5/admin/cart/update/${x.id}">
						...
						<div class="card mb-4">
							...
							<div class="card-body">
								...
								<button type="button" class="btn btn-primary btn-lg btn-block"
									onclick="window.location.href='/AssignmentJava5/admin/checkout'">
